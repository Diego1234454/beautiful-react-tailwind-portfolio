                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="space-y-8">
                            ...
                            <div className="pt-8 ">
                                ...
                                <div className="flex space-x-4 justify-center">
                                    <a href="https://www.linkedin.com/in/diego-allan-véliz-medina-29906427a" target="_blank"><Linkedin/></a>
                                    <a href="https://x.com/Diego36196752" target="_blank"><Twitter/></a>
                                    <a href="https://www.instagram.com/allan_med7/" target="_blank"><Instagram/></a>
                                    <a href="https://www.facebook.com/allan.veliz.237464/" target="_blank"><Facebook/></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-card p-8 rounded-lg shadow-xs" onSubmit={handleSubmit}>
                            ...
                            <form action="" className="space-y-8">
                                <div>
                                    <label htmlFor="name" className="block text-sm font-bold mb-@">Your name...</label>
                                ...
                                <div>
                                    <label htmlFor="email" className="block text-sm font-bold mb-@">Your email</label>
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-sm font-bold mb-@">Your Message</label>
                                    <textarea id="message" name="message" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outlind-hidden focus:ring-2 focus:ring-primary resize-none"
                                           placeholder="Input your message..."/>
                                </div>
                                {/*USAR EMAIL JS PARA MANDAR MENSAJES POR EMAIL CON ESTA API*/}
