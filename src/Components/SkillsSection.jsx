...
const skills = [
    ...
    {name: "JavasSript", level: 75, category: "frontend"},

    /*BACKEND*/
    {name: "C#", level: 75, category: "backend"},
    {name: "Python", level: 40, category: "backend"},
    {name: "SQL/T-SQL", level: 90, category: "backend"},

    /*TOOLS*/
    {name: "VS Code", level: 90, category: "tools"},
    {name: "WebStorms", level: 85, category: "tools"},
    {name: "Visual Studio", level: 90, category: "tools"},
    {name: "Microsoft SQL Server", level: 90, category: "tools"},
    {name: "SQL Server Reporting Services", level: 90, category: "tools"},
